...
def home(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            messages.success(request, "This is embarresing... there was a problem logging you in, how about another try?")
            return redirect('home')
    else: 
...
def update_company(request, pk):
     if request.user.is_authenticated:
        ...
        if form.is_valid():
               form.save()
               messages.success(request, "Great! That company has been updated successfully!")
               return redirect('home')
